		...
		while(true) {
			...
			try {
				...
				if(input.equalsIgnoreCase("q")) { // 대소문자 무시(ignore)
					...
					System.out.println(" history - 최근에 입력한 명령어는 " + gq.MAX_SIZE + "개 보여줍니다.");
				}
...
//					}
					gq.q.forEach(u->System.out.print(" " + u));
					//for(String a: q) System.out.println(a);
				}
				else {
					gq.save(input);
