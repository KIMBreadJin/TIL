...
const abstractionClockTime = (date) => ({
  hours: date.getHours(),
...
const startTicking = () =>
  setInterval(
    compose(clear, getCurrentTime, abstractionClockTime, convertToCivilianTime, doubleDigits, formatClock('hh:mm:ss tt'), display(log)),
    oneSecond()
  )
startTicking()
